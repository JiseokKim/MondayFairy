 ...
 */
public class UserFaceView extends Thread {
    private final static String TAG = "UserFaceView";
    ...
    public UserFaceView(Context context, TextureView textureView) {
        mContext = context;
    ...
    public void openCamera() {
        ...
        try {
            ...
            if (permissionCamera == PackageManager.PERMISSION_DENIED) {
                ActivityCompat.requestPermissions((Activity) mContext, new String[]{Manifest.permission.CAMERA}, CallPlayerActivity.REQUEST_CAMERA);
            } else {
